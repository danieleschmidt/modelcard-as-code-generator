...
from .circuit_breaker import API_CIRCUIT_CONFIG, FILE_CIRCUIT_CONFIG
from .circuit_breaker import registry as circuit_registry
from .exceptions import ModelCardError, ResourceError
from .generator import DataSourceParser
from .generator import ModelCardGenerator as BaseModelCardGenerator
from .logging_config import get_logger
from .models import CardConfig, ModelCard
...
class EnhancedModelCardGenerator(BaseModelCardGenerator):
    ...
    def generate(self, **kwargs) -> ModelCard:
        """Override base generate method to track statistics."""
    ...
    async def generate_async(
        ...
        **kwargs
        ...
        try:
            ...
            duration_ms = (time.time() - start_time) * 1000
            self.generation_stats["total_failures"] += 1
            self.generation_stats["total_generated"] += 1  # Count attempted generations
    ...
    def get_performance_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "rate_limiter_stats": {
                "api_rate_limiter": getattr(api_rate_limiter, "get_stats", lambda: {})(),
                "file_operation_rate_limiter": getattr(file_operation_rate_limiter, "get_stats", lambda: {})()
            }
        }
